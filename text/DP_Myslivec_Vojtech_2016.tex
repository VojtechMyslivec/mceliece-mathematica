...
\abstractEN{In this work, we deal with a code-based public-key cryptosystem
    ...
    digital signature scheme, and we focus on the cryptanalysis and practical
    aspects of this cryptosystem. An illustrative implementation in Wolfram
    Mathematica software was developed and we evaluated the time complexity of
    the algorithms.
} %TODO
