...
% TODO
    \vfil
    Tento text ještě přepíšu a rozdělím mezi abstrakt a úvod.
    \vfil
%TODO
...
V~kapitole~\ref{kap_mceliece} uvádíme algoritmy navržené
...
% --------------------------------------------------------------------
\paragraph{Odolnost vůči kvantovým počítačům} \hfil \\
Jeden z~hlavních důvodů popularity algoritmu \emph{McEliece} je fakt, že není
znám algoritmus pro kvantový počítač, který by dokázal kryptosystém prolomit
...
% ====================================================================
\chapter{Kryptosystém Niederreiter}\label{kap_niederreiter}
...
% --------------------------------------------------------------------
\section{Algoritmy pro šifrování a dešifrování}
...
% --------------------------------------------------------------------
\section{Vlastnosti kryptosystému}
...
% --------------------------------------------------------------------
\paragraph{Překážky pro použití McEliece pro podepisování} \hfil \\
...
V~této práci budeme mezi těmito reprezentacemi nadále volně přecházet, jak bude
